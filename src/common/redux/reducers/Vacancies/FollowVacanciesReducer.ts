...
import { VacanciesStateProps } from '../../../interfaces/Props/StateProps';
import {
  GET_FOLLOW_VACANCIES_ERROR,
  GET_FOLLOW_VACANCIES_LOAD,
  GET_FOLLOW_VACANCIES_SUCCESS,
} from '../../actions/Vacancies/FollowVacancies';
import { VacanciesAction } from '../../actions/Vacancies/VacanciesActions';
